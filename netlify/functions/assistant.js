...
export default async (request) => {
  ...
  try {
    ...
    const context = comparisons.map((item, index) => ({
      ...
      programSource: item.programSource || null,
      programVerificationLabel: item.programVerificationLabel || null,
      officialProgramUrl: item.officialProgramUrl || null,
      startAge: item.startAge || null,
      endAge: item.endAge || null,
      tenYearTimeline: item.timeline || null,
